    ...
    return SizedBox(
      ...
      child: Center(
        child: SizedBox(
          ...
          child: Row(
            children: [
              Image.asset("images/logo/logo.png",width: 50,height: 50,),
              const SizedBox(
                width: 10,
              ),
              InkWell(
              ...
              Container(
                ...
                child: InkWell(
                  ...
                  child:
                  Center(
                    child: Text("Documentation", style: TextStyle(
              ...
              Container(
                ...
                child: InkWell(
                  ...
                  child:
                  Center(
                    child: Image.asset("images/icon/twitter.png",height: 30,width: 30,color: Colors.grey,),
                  ),),
              ),
              const SizedBox(width: 15,),
              Container(
                ...
                child: InkWell(
                  ...
                  child:
                  Center(
                    child: Image.asset("images/icon/github.png",height: 25,width: 25,color: Colors.grey,),
                  ),),
              ),
            ],
          ),
