...
class UntilsBaseScaffold extends StatefulWidget {
  const UntilsBaseScaffold({
    Key? key,
    this.appBar,
    this.body,
  ...
  @override
  _UntilsBaseScaffoldState createState() => _UntilsBaseScaffoldState();
}

class _UntilsBaseScaffoldState extends State<UntilsBaseScaffold> {
